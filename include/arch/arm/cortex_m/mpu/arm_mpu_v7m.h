...
/* Attributes for no-cache enabling */

#define K_MEM_PARTITION_P_NA_U_NA_NOCACHE (K_MEM_PARTITION_P_NA_U_NA \
	| NORMAL_OUTER_INNER_NON_CACHEABLE_NON_SHAREABLE)
#define K_MEM_PARTITION_P_RW_U_RW_NOCACHE (K_MEM_PARTITION_P_RW_U_RW \
	| NORMAL_OUTER_INNER_NON_CACHEABLE_NON_SHAREABLE)
#define K_MEM_PARTITION_P_RW_U_RO_NOCACHE (K_MEM_PARTITION_P_RW_U_RO \
	| NORMAL_OUTER_INNER_NON_CACHEABLE_NON_SHAREABLE)
#define K_MEM_PARTITION_P_RW_U_NA_NOCACHE (K_MEM_PARTITION_P_RW_U_NA \
	| NORMAL_OUTER_INNER_NON_CACHEABLE_NON_SHAREABLE)
#define K_MEM_PARTITION_P_RO_U_RO_NOCACHE (K_MEM_PARTITION_P_RO_U_RO \
	| NORMAL_OUTER_INNER_NON_CACHEABLE_NON_SHAREABLE)
#define K_MEM_PARTITION_P_RO_U_NA_NOCACHE (K_MEM_PARTITION_P_RO_U_NA \
	| NORMAL_OUTER_INNER_NON_CACHEABLE_NON_SHAREABLE)

#define K_MEM_PARTITION_P_RWX_U_RWX_NOCACHE (K_MEM_PARTITION_P_RWX_U_RWX \
	| NORMAL_OUTER_INNER_NON_CACHEABLE_NON_SHAREABLE)
#define K_MEM_PARTITION_P_RWX_U_RX_NOCACHE  (K_MEM_PARTITION_P_RWX_U_RX  \
	| NORMAL_OUTER_INNER_NON_CACHEABLE_NON_SHAREABLE)
#define K_MEM_PARTITION_P_RX_U_RX_NOCACHE   (K_MEM_PARTITION_P_RX_U_RX   \
	| NORMAL_OUTER_INNER_NON_CACHEABLE_NON_SHAREABLE)
