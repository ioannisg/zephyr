...
#define K_MEM_PARTITION_P_RW_U_RW_NOCACHE \
	{(P_RW_U_RW_Msk | NOT_EXEC), MPU_MAIR_INDEX_SRAM_NOCACHE}
#define K_MEM_PARTITION_P_RW_U_NA_NOCACHE \
	{(P_RW_U_NA_Msk | NOT_EXEC), MPU_MAIR_INDEX_SRAM_NOCACHE}
#define K_MEM_PARTITION_P_RO_U_RO_NOCACHE \
	{(P_RO_U_RO_Msk | NOT_EXEC), MPU_MAIR_INDEX_SRAM_NOCACHE}
#define K_MEM_PARTITION_P_RO_U_NA_NOCACHE \
	{(P_RO_U_NA_Msk | NOT_EXEC), MPU_MAIR_INDEX_SRAM_NOCACHE}

/* Execution-allowed attributes */
#define K_MEM_PARTITION_P_RWX_U_RWX_NOCACHE \
	{(P_RW_U_RW_Msk), MPU_MAIR_INDEX_SRAM_NOCACHE}
#define K_MEM_PARTITION_P_RX_U_RX_NOCACHE \
	{(P_RO_U_RO_Msk), MPU_MAIR_INDEX_SRAM_NOCACHE}
