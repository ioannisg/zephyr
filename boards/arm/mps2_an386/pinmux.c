...
/**
 * @brief Pinmux driver for ARM MPS2 AN386 Board
 *
 * The ARM MPS2 AN386 Board has 4 GPIO controllers. These controllers
 ...
 *
 * For the GPIO controllers configuration ARM MPS2 AN386 Board follows the
...
/*
 * This is the mapping from the ARM MPS2 AN386 Board pins to GPIO
 * controllers.
 *
 * D0 : EXT_0
 * D1 : EXT_4
